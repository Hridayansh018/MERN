  ...
  return(
    <section id="review" className="container mx-auto mb-8 mt-12">
      <div className="flex flex-col">
        <p className="mb-10 mx-2 text-3xl font-light leading-normal tracking-tighter lg:mx-40 lg:text-6xl">
          {REVIEW.content}
        </p>
      ...
      <div className="mt-14 flex flex-col items-center justify-center gap-6 md:flex-row">
        {[customer1, customer2, customer3, customer4].map((customer, index) => (
          <img key={index} src={customer} width={80} height={80} alt="customer" className="h-[300px] w-[200px] rounded-br-3xl rounded-tl-3xl object-cover" />
        ))}
      </div>
    </section>
  )
