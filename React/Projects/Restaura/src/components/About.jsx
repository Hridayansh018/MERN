...
const About = () => {
  return(
    <section className="container mx-auto mb-8" id="about">
      <h2 className="text-3xl mb-8 text-center tracking-tighter lg:text-4xl">About Us</h2>
      <div className="flex flex-wrap">
        ...
        <div className="w-full px-2 lg:w-1/2">
          ...
          <p className="m-8 text-2xl leading-relaxed tracking-tight">{ABOUT.content}</p>
        </div>
      </div>
    </section>
  )
